...
*/
    public mapview(Context c, AttributeSet a, int o) {
        super(c, a, o);
        init(c);
    }
    ...
    public mapview(Context c, GoogleMapOptions o) {
        super(c, o);
        init(c);
    }
    ...
    private GestureDetector.SimpleOnGestureListener mGestudeListener =
            new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
                    Toast.makeText(getContext(), "scrolling in map view with context: "+getContext().toString(), Toast.LENGTH_LONG).show();
