...
// ...Irrelevant code for customizing the buttons and title
                ...
                if(TelephoneContacts.campus_location.equals("saharanpur")) {std_code = "0133227";}
                ...
                r1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (call_status1) {
                            ...
                            Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel: " + std_code + TelephoneContacts.contactnos_iitr_o[position]));
                ...
                r2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (call_status2) {
                            ...
                            Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel: " + std_code + TelephoneContacts.contactnos_iitr_r[position]));
                            view.getContext().startActivity(intent);
                            alertDialog.dismiss();
                        } else {
                            Toast.makeText(mContext, "Contact Number not available", Toast.LENGTH_SHORT).show();
                ...
                r3.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (call_status3) {
                            ...
                            Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel: " + std_code + TelephoneContacts.contactnos_bsnl[position]));
                            view.getContext().startActivity(intent);
                            alertDialog.dismiss();
                        } else {
                            Toast.makeText(mContext, "Contact Number not available", Toast.LENGTH_SHORT).show();
