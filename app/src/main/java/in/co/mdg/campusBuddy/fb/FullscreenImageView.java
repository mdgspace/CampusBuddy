...
public class FullscreenImageView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(intent.getStringExtra("img_src")).crossFade().fitCenter().into(new SimpleTarget<GlideDrawable>() {
            @Override
            public void onResourceReady(GlideDrawable resource, GlideAnimation<? super GlideDrawable> glideAnimation) {
                mContentView.setImageDrawable(resource);
        ...
        findViewById(R.id.title_content).setOnTouchListener(mDelayHideTouchListener);
